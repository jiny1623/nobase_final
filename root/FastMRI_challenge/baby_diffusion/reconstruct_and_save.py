...
def parse():
    ...
    parser.add_argument('-n', '--net-name', type=Path, default='baby_diffusion', help='Name of network')
    parser.add_argument('-t', '--data-path', type=Path, default='/Data/', help='Directory of data')
    parser.add_argument('-o', '--out-path', type=Path, default='../recon_data/recon_diffusion/')
