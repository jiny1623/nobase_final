...
def train(args):
    ...
    model = VarNet(num_cascades=args.cascade, 
                   chans=args.chans, 
                   sens_chans=args.sens_chans).cuda()
    
#     summary(model, [(16, 768, 396, 2), (1, 1, 396, 1)], batch_size=1)
...
#     print(current_epoch_fn())
    ...
    train_data_transform = DataTransform(False, args.max_key, augmentor)
    val_data_transform = DataTransform(False, args.max_key)
    
    train_loader = create_data_loaders(data_path = args.data_path_train, args = args, _transform = train_data_transform, shuffle=True)
