...
class SliceData(Dataset):
    ...
    def __getitem__(self, i):
        ...
        which_data = fname.parent.parent.name   # fname.parent.name == 'image'
        with h5py.File(self.recon_path / 'recon_varnet' / which_data / fname.name, "r") as hf:
            varnet = hf['image_varnet'][dataslice]
        with h5py.File(self.recon_path / 'recon_diffusion' / which_data / fname.name, "r") as hf:
