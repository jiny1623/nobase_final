...
#     optimizer = torch.optim.Adam(model.parameters(), args.lr)
    ### optimizer for NAFNet
    optimizer = torch.optim.AdamW(model.parameters(), lr = 0.001, betas = (0.9, 0.9))
    best_val_loss = 1.
    start_epoch = 0
    
    #########################################################################################
    ### new data path : './Data/train/' './Data/val/' (train.py에서 default arg로 수정해놓음) ###
    #########################################################################################
